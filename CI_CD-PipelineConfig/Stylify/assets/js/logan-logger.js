...
/*! Logan is a fork of the original js-logger from the link below.
* For those in the know how, Logan is the name of Wolverine chracter from X-MEN.
* Tapasvi Moturu, tapasvi_moturu@intuit.com
*/
...
(function (window) {
    ...
    Logger.INFO = defineLogLevel(16, 'INFO');
    Logger.WARN = defineLogLevel(8, 'WARN');
    Logger.ERROR = defineLogLevel(4, 'ERROR');
    ...
    var globalLogger = new ContextualLogger({ filterLevel: Logger.ERROR });
    ...
    Logger.useDefaults = function (defaultLevel) {
        ...
        Logger.setLevel(defaultLevel || Logger.ERROR);
        Logger.setHandler(function (messages, context) {
            ...
            if (context.level === Logger.INFO && console.info) {
                hdlr = console.info;
            } else if (context.level === Logger.WARN && console.warn) {
                hdlr = console.warn;
            } else if (context.level === Logger.ERROR && console.error) {
                hdlr = console.error;
            } else if (context.level === Logger.DEBUG && console.debug) {
                hdlr = console.debug;
            } else if (context.level === Logger.TRACE && console.info) {
                hdlr = console.info;
            }
